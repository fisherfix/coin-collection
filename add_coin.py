...
coins = [
    {
        "number": "GK-010",
        "image": "images/GK-010.jpg",
        "grade": "AU",
        "title": "弗里几亚劳迪西亚城·蛇篮式四德拉克马",
        "subtitle": "LAODIKEIA AD LYCUM · SERPENT FROM CISTA MYSTICA",
        "era": "公元前133-前67年",
        "denomination": "Tetradrachm 四德拉克马",
        "material": "Silver 银 · 27.5mm · 12.56g",
        "reference": "—",
        "description": "蛇篮（Cista Mystica）是古希腊祭祀酒神狄奥尼索斯仪式中的神圣器物——一个装有幼蛇的柳编篮子，祭司将其取出让蛇爬出，以此象征神迹与重生。这一意象被广泛铸造在银币背面，成为古希腊钱币中最具神秘感的经典图式。此币正面蛇从篮中爬出，周围常春藤花环环绕；背面双蛇缠绕弓箭袋，铭文「AΠOΛΛΩNIOΣ ΕΥΑΡΧΟΥ」清晰漂亮——地方行政官阿波罗尼奥斯，尤阿尔科斯之子。公元前133年帕加马王国灭亡，小亚细亚落入罗马人之手，此币恐由罗马总督发行，兑换比率为三枚狄纳里银币换一枚蛇篮四德拉克马。",
        "obverse": "正面: 蛇正从篮中爬出，周围常春藤花环环绕，花叶饱满",
        "reverse": "背面: 两条蛇缠绕弓箭袋 · AΠOΛΛΩNIOΣ ΕΥΑΡΧΟΥ · 左下角ΛΑΟ",
        "tags": ["蛇篮", "劳迪西亚", "弗里几亚", "罗马统治", "狄奥尼索斯", "常春藤"],
        "price": "¥2,888",
        "provenance": "<strong>熊太乐</strong> · 私洽 · 2025-01",
        "category": "greek",
    },
]
