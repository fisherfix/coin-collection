...
coins = [
    {
        "number": "GK-009",
        "image": "images/GK-009.jpg",
        "grade": "VF",
        "title": "雅典城·新式猫头鹰 四德拉克马",
        "subtitle": "ATHENS · NEW STYLE OWL",
        "era": "BC 2nd-1st Century",
        "denomination": "Tetradrachm 四德拉克马",
        "material": "Silver 银 · 31.6mm · 16.7g",
        "reference": "—",
        "description": "雅典猫头鹰银币是古希腊最具代表性的货币，从公元前5世纪延续至公元前1世纪，成为古代地中海世界的硬通货。古典时期结束后，雅典于公元前2世纪摆脱马其顿控制，重启银币铸造，采用全新设计风格——新式猫头鹰（New Style）。与古典版相比，新式猫头鹰正面雅典娜头像更为精致，头戴装饰丰富的阿提卡式头盔；背面猫头鹰立于双耳陶罐（amphora）之上，周边环绕橄榄枝，并刻有地方官姓名与徽记，体现了希腊化时期雅典城邦的自治与繁荣。",
        "obverse": "正面: 雅典娜女神戴阿提卡式头盔头像",
        "reverse": "背面: 猫头鹰立于双耳陶罐上 · 橄榄枝环绕 · ΑΘΕ",
        "tags": ["雅典", "猫头鹰", "希腊化", "四德", "雅典娜"],
        "price": "¥13,500",
        "provenance": "<strong>大象古币</strong> · 私洽 · 2025",
        "category": "greek",
    },
]
